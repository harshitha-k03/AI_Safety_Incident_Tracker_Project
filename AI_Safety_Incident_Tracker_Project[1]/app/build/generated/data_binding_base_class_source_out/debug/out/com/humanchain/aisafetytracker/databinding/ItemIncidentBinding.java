...
public final class ItemIncidentBinding implements ViewBinding {
  ...
  private ItemIncidentBinding(@NonNull LinearLayout rootView, @NonNull Button buttonDelete,
      @NonNull TextView textViewSeverity, @NonNull TextView textViewTimestamp,
  ...
  public static ItemIncidentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemIncidentBinding((LinearLayout) rootView, buttonDelete, textViewSeverity,
